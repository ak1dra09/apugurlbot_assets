...
class Settings:
    ...
    burn_poll_interval_seconds: int = 60
    burn_media_path: str = "logo.jpg"
    burn_chat_username: str = "ApugurlCHAT"
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            burn_poll_interval_seconds=int(os.getenv("BURN_POLL_INTERVAL_SECONDS", "60")),
            burn_media_path=os.getenv("BURN_MEDIA_PATH", "logo.jpg"),
            burn_chat_username=os.getenv("BURN_CHAT_USERNAME", "ApugurlCHAT").lstrip("@"),
        )
